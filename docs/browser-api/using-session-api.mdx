...
If you just want a quick, zero-setup CDP URL, see [Quickconnect](/dash/browser-api/using-quickconnect) instead.
...
Use that CDP URL with Playwright/Puppeteer — or see the guide: [/dash/browser-api/guides/cdp-playwright](/dash/browser-api/guides/cdp-playwright).
...
- Quickconnect (zero-config CDP): [/dash/browser-api/using-quickconnect](/dash/browser-api/using-quickconnect)
- CDP + Playwright/Puppeteer guide: [/dash/browser-api/guides/cdp-playwright](/dash/browser-api/guides/cdp-playwright)
